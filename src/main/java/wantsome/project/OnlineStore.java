...
import wantsome.online_store.web.controllers.users.ProfilePageController;
import wantsome.online_store.web.controllers.ShopController.ShopController;
import wantsome.online_store.web.controllers.cart.CardPaymentController;
...
public class OnlineStore {
    ...
    public static final String CHECKOUT = SECURE_PREFIX + "/checkout";
    ...
    public static final String CARD_PAYMENT = SECURE_PREFIX + "/cardpayment";
    ...
    public static void main(String[] args) {
        ...
        Javalin.create(config -> {
                ...
                .get(CHECKOUT, CartController::showCheckOut)
                .post(CHECKOUT, CartController::handleCheckOut)
                .post(CARD_PAYMENT, CardPaymentController::showCardPaymentPageSuccesfully)
                .get(PROFILE_PAGE, ProfilePageController::showProfilePage)
                .start();
